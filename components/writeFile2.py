...
class MyComponent(component):
    def __new__(cls):
        instance = Grasshopper.Kernel.GH_Component.__new__(cls,
            "Name2", "Nickname2", """Provides a scripting component.""", "Redback", "Utils")
        return instance
    
    def get_ComponentGuid(self):
        return System.Guid("2d551884-0adb-4c4a-89a2-2a06ab266112")
...
class AssemblyInfo(GhPython.Assemblies.PythonAssemblyInfo):
    ...
    def get_Id(self):
        return System.Guid("880ff1f0-b0d8-4cf8-8c21-0b0b36aecdb2")