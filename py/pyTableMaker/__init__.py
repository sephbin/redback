	...
	def generateStr(self):
		...
		for cssline in self.options["css"]:
			for k,v in cssline["style"].items():
				if k == "paragraphStyle":
					parastyles.append('<ParagraphStyle Self="ParagraphStyle/Generated%3a{name}" Name="Generated:{name}" Imported="false" NextStyle="ParagraphStyle/Generated%3a{name}" SplitDocument="false" EmitCss="true" IncludeClass="true" ExtendedKeyboardShortcut="0 0 0" EmptyNestedStyles="true" EmptyLineStyles="true" EmptyGrepStyles="true" KeyboardShortcut="0 0" AppliedLanguage="$ID/English: UK"> <Properties><BasedOn type="object">ParagraphStyle/$ID/NormalParagraphStyle</BasedOn><PreviewColor type="enumeration">Nothing</PreviewColor> </Properties> </ParagraphStyle>'.format(name=v))#StyleUniqueId="8ad5365e-a91f-4f93-b49a-3810b988a0b0"
				if k == "characterStyle":
				...
				if k == "cellStyle":
					cellstyles.append('<CellStyle Self="CellStyle/Generated%3a{name}" ExtendedKeyboardShortcut="0 0 0" KeyboardShortcut="0 0" Name="Generated:{name}" TextTopInset="4" TextLeftInset="4" TextBottomInset="4" TextRightInset="4" TopInset="4" LeftInset="4" BottomInset="4" RightInset="4"></CellStyle>'.format(name=v))
				if k == "tableStyle":
		...
		<ParagraphStyle Self="ParagraphStyle/Generated%3aNone" Name="Generated:None" Imported="false" NextStyle="ParagraphStyle/Generated%3aNone" SplitDocument="false" EmitCss="true" IncludeClass="true" ExtendedKeyboardShortcut="0 0 0" EmptyNestedStyles="true" EmptyLineStyles="true" EmptyGrepStyles="true" KeyboardShortcut="0 0" AppliedLanguage="$ID/English: UK"> <Properties><BasedOn type="object">ParagraphStyle/$ID/NormalParagraphStyle</BasedOn><PreviewColor type="enumeration">Nothing</PreviewColor> </Properties> </ParagraphStyle>
			<Properties>
		...
		<CellStyleGroup Self="CellStyleGroup/$ID/Generated" Name="$ID/Generated">
			<CellStyle Self="CellStyle/Generated%3aNone" ExtendedKeyboardShortcut="0 0 0" KeyboardShortcut="0 0" Name="Generated:None"></CellStyle>
			{cellstyles}
		</CellStyleGroup>
		</RootCellStyleGroup>
		<RootTableStyleGroup Self="u90">
		<TableStyleGroup Self="TableStyleGroup/$ID/Generated" Name="$ID/Generated">
			<TableStyle Self="TableStyle/Generated%3aNone" ExtendedKeyboardShortcut="0 0 0" Name="Generated:Basic Table" KeyboardShortcut="0 0"> <Properties> <BasedOn type="string">$ID/[No table style]</BasedOn> </Properties> </TableStyle>
			{tablestyles}
		</TableStyleGroup>
		</RootTableStyleGroup>
...
def settingsGuide():
	OP = '''# YAML Format for options. Copy and paste this into a panel to edit.
	columnWidths:
- 10
- 20
columnWidthsRev:
...
variables:
  ...
  '''
	...
	"border{weight:1;}",
	"[xPos=1]{weight:2;}",
	"border[xPos=0]{weight:0;}",
	"border[yPos=0]{weight:0;}",
	"border[xPosRev=-1]{weight:0;}",
	"border[yPosRev=-1]{weight:0;}",
	]
	return (OP,CS)